...
package com.mimile.pickerview.wheel.widget;
...
import com.mimile.pickerview.R;
import com.mimile.pickerview.wheel.widget.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0xeeffffff,
			0xeaffffff, 0x00ffffff };

...
import com.mimile.onlinestore.util.ProgressResponseBody;
...
import static com.mimile.onlinestore.util.ProgressResponseBody.*;

/**
 * Created by caidongdong on 2016/12/9 11:33
 * email : mircaidong@163.com
 * 含有下载、上传显示进度以及断点续传的管理器
 */
public class DownLoadManager {
    ...
    public DownLoadManager(String url, File destination, ProgressListener progressListener) {
        this.url = url;

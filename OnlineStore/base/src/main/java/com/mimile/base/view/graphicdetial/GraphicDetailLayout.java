...
/**
 * Created by caidongdong on 2016/12/26 14:05
 * email : mircaidong@163.com
 */

public class GraphicDetailLayout extends RelativeLayout {
    /**
     * 自动上滑
     */
    ...
    public GraphicDetailLayout(Context context) {
        super(context);
        init();
    }

    public GraphicDetailLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public GraphicDetailLayout(Context context, AttributeSet attrs, int defStyle) {

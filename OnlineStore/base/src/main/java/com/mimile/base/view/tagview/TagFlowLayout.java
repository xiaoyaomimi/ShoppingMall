package com.mimile.base.view.tagview;
...
/**
 * Created by caidongdong on 2016/12/27 16:14
...
//            lp.rightMargin = clp.rightMargin;
            ...
            if (defaultSelectedPosition != -1 && i == defaultSelectedPosition) {
                tagViewContainer.setChecked(true);
            }else {
    ...
    private void doSelect(TagView child, int position)
    {
        if (mAutoSelectEffect)
        {
            if (defaultSelectedPosition != -1 && defaultSelectedPosition != position) {
                TagView def = (TagView) getChildAt(defaultSelectedPosition);
